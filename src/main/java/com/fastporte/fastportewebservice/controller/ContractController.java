...
public class ContractController {
    ...
    public ContractController(IContractService contractService, IClientService clientService,
            IDriverService driverService, IStatusContractService statusContractService,
    ...
    public ResponseEntity<List<Contract>> findAllContracts() { // Response entity: la clase por defecto de spring para
                                                               // responder desde un controlador de API
        try {
    ...
    public ResponseEntity<List<Contract>> findContractByStatusOfferUser(@PathVariable("user") String user,
    ...
    public ResponseEntity<List<Contract>> findContractByStatusPending(@PathVariable("id") Long id,
    ...
    public ResponseEntity<List<Contract>> findContractByStatusHistory(@PathVariable("id") Long id,
            @PathVariable("user") String user) {
        try {
            List<Contract> contracts = contractService.getAll();
    ...
    // Cambiar el status del contrato de OFFER a PENDING - aquí se añade al driver
    // al contrato
